    ...
    <main class="content">
        ...
        <section class="section-how">
            <div class="container">
                ...
                <p class="text-center">Fill the details below</p>
                <div class="how">
                    <form action="{{ route('playLotto') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="occupation" class="form-control" id="inputPassword4" placeholder="Occupation">
                            </div>
                        </div>
