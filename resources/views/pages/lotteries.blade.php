...
<div class="row">
    <div class="col-lg-8">
        <div class="text-muted page_txt"><p>Here is the list of the biggest lotteries in the world! You can play all of them from the comfort of your own home. We have everything you could dream of: from <a href="en/play-lottery/mega-millions/" target="_blank">MEGA Millions</a>, with its world-record Jackpot of $ 1.6 billion, to exotic games with outstanding winning odds!</p></div>
    </div>
    <div class="col-lg-4 col-md-6">
        <a href="en/bundles/" class="subscblock">
            <div class="subscblock_cont">
                <div class="subscblock_title">Feel like a kid in a candy store?</div>
                <div class="subscblock_txt">Don't choose just one lottery, buy a bundle!</div>
            </div>
...
<h3>All lotteries</h3>
<div class="lotteries-top">
    <div class="sorting d-none d-md-flex">
        <div class="sorting_title">Sort by:</div>
        <ul>
            <li class=""><a href="en/play-lottery/?filter=jackpot" class="reload" data-callback="lotteries_sorting_callback();">Jackpot</a></li>
            <li class=""><a href="en/play-lottery/?filter=draw_date" class="reload" data-callback="lotteries_sorting_callback();">Date</a></li>
            <li class=""><a href="en/play-lottery/?filter=title" class="reload" data-callback="lotteries_sorting_callback();">A-Z</a></li>
            <li class="active"><a href="en/play-lottery/?filter=country" class="reload" data-callback="lotteries_sorting_callback();">Country</a></li>
            <li class=""><a href="en/play-lottery/?filter=odds" class="reload" data-callback="lotteries_sorting_callback();">Odds</a></li>
            <li class=""><a href="en/play-lottery/?filter=score" class="reload" data-callback="lotteries_sorting_callback();">Rating</a></li>
            <li class=""><a href="en/play-lottery/?filter=price" class="reload" data-callback="lotteries_sorting_callback();">Price</a></li>
        </ul>
    </div>
    <div class="sorting_sel sorting_sel-mob">
        <div class="text-muted page_txt">Sort by:</div>
        <div class="dropdown bootstrap-select"><select class="selectpicker" onchange="ajax_reload(this.value, '', 'lotteries_sorting_callback();');">
            <option value="en/play-lottery/?filter=jackpot" selected="" data-content="<span>Jackpot</span>">Jackpot</option>
            <option value="en/play-lottery/?filter=draw_date">Date</option>
            <option value="en/play-lottery/?filter=title">A-Z</option>
            <option value="en/play-lottery/?filter=country">Country</option>
            <option value="en/play-lottery/?filter=odds">Odds</option>
    ...
    <div class="lotteries-action">
        ...
        <div class="d-none d-md-block w-100">
            <div id="lotteries-views" class="lotteries-views">
                <span class="lotteries-view active" onclick="lotteries_view(0)" data-toggle="tooltip" title="" data-original-title="Click to display the list of lotteries as tiles.">
                    <img src="https://static.cdnland.com/new/images/lotteries-view1.svg" alt="">
                </span>
                <span class="lotteries-view" onclick="lotteries_view(1)" data-toggle="tooltip" title="" data-original-title="Click to display the list of lotteries as a table.">
                    <img src="https://static.cdnland.com/new/images/lotteries-view2.svg" alt="">
                </span>
            </div>
        </div>
    </div>
    ...
    <div class="lottery_sel">
        ...
        <div class="event-easy-pick-cont">
            <select name="easy_pick" class="lottery_sel_select event-easy-pick-select">
                <option></option>
                <option value="/en/play-lottery/lotto-austria/?from=play_table&amp;easy_pick=1&amp;extra_jackpot=" data-event-easy-pick="1">1 line for $ 3.80</option>
...
<div class="lotteries_item_bot">
    ...
    <div class="lottery_sel">
        ...
        <div class="event-easy-pick-cont">
            <select name="easy_pick" class="lottery_sel_select event-easy-pick-select">
                <option></option>
                <option value="/en/play-lottery/oz-lotto/?from=play_table&amp;easy_pick=4&amp;extra_jackpot=" data-event-easy-pick="1">4 lines for $ 10.04</option>
...
<div class="lotteries_item_bot">
    ...
    <div class="lottery_sel">
        ...
        <div class="event-easy-pick-cont">
            <select name="easy_pick" class="lottery_sel_select event-easy-pick-select">
                <option></option>
                <option value="/en/play-lottery/powerball-australia/?from=play_table&amp;easy_pick=4&amp;extra_jackpot=" data-event-easy-pick="1">4 lines for $ 7.24</option>
...
<div class="lotteries_item_bot">
    ...
    <div class="lottery_sel">
        ...
        <div class="event-easy-pick-cont">
            <select name="easy_pick" class="lottery_sel_select event-easy-pick-select">
                <option></option>
                <option value="/en/play-lottery/au-saturday-lotto/?from=play_table&amp;easy_pick=6&amp;extra_jackpot=" data-event-easy-pick="1">6 lines for $ 8.82</option>
...
<div class="lotteries_item_bot">
    ...
    <div class="lottery_sel">
        ...
        <div class="event-easy-pick-cont">
            <select name="easy_pick" class="lottery_sel_select event-easy-pick-select">
                <option></option>
                <option value="/en/play-lottery/au-set-for-life/?from=play_table&amp;easy_pick=7&amp;extra_jackpot=" data-event-easy-pick="1">7 lines for $ 7.49</option>
...
</div><div class="ad-block col-12"><div class="payed_wrap">
<div class="payed">
<div class="payed_cont">
<div class="h2">We paid out in prizes:</div>
<div class="payed_txt">Over 15,115,020 winners worldwide!</div>
</div>
...
<div class="lotteries_item_bot">
    ...
    <div class="lottery_sel">
        ...
        <div class="event-easy-pick-cont">
            <select name="easy_pick" class="lottery_sel_select event-easy-pick-select">
                <option></option>
                <option value="/en/play-lottery/mega-sena/?from=play_table&amp;easy_pick=4&amp;extra_jackpot=" data-event-easy-pick="1">4 lines for $ 8.28</option>
...
<div class="lotteries_item_bot">
    ...
    <div class="lottery_sel">
        ...
        <div class="event-easy-pick-cont">
            <select name="easy_pick" class="lottery_sel_select event-easy-pick-select">
                <option></option>
                <option value="/en/play-lottery/lotto-649/?from=play_table&amp;easy_pick=1&amp;extra_jackpot=" data-event-easy-pick="1">1 line for $ 5.91</option>
...
<div class="lotteries_item_bot">
    ...
    <div class="lottery_sel">
        ...
        <div class="event-easy-pick-cont">
            <select name="easy_pick" class="lottery_sel_select event-easy-pick-select">
                <option></option>
                <option value="/en/play-lottery/lotto-6-aus-49/?from=play_table&amp;easy_pick=1&amp;extra_jackpot=" data-event-easy-pick="1">1 line for $ 3.80</option>
...
<div class="lotteries_item_bot">
    ...
    <div class="lottery_sel">
        ...
        <div class="event-easy-pick-cont">
            <select name="easy_pick" class="lottery_sel_select event-easy-pick-select">
                <option></option>
                <option value="/en/play-lottery/el-gordo/?from=play_table&amp;easy_pick=2&amp;extra_jackpot=" data-event-easy-pick="1">2 lines for $ 9.68</option>
...
<div class="lotteries_item_bot">
    ...
    <div class="lottery_sel">
        ...
        <div class="event-easy-pick-cont">
            <select name="easy_pick" class="lottery_sel_select event-easy-pick-select">
                <option></option>
                <option value="/en/play-lottery/la-primitiva/?from=play_table&amp;easy_pick=1&amp;extra_jackpot=" data-event-easy-pick="1">1 line for $ 3.04</option>
...
<div class="lotteries_item_bot">
    ...
    <div class="lottery_sel">
        ...
        <div class="event-easy-pick-cont">
            <select name="easy_pick" class="lottery_sel_select event-easy-pick-select">
                <option></option>
                <option value="/en/play-lottery/bonoloto/?from=play_table&amp;easy_pick=2&amp;extra_jackpot=" data-event-easy-pick="1">2 lines for $ 3.70</option>
...
</div><div class="ad-block col-12"><a href="en/invite-friend/" target="_blank" class="freeban">
<div class="freeban_img"><img src="https://static.cdnland.com/new/images/svg/freeban.svg" alt=""></div>
<div class="freeban_cont">
<div class="freeban_title">Invite a friend!</div>
...
<div class="lotteries_item_bot">
    ...
    <div class="lottery_sel">
        ...
        <div class="event-easy-pick-cont">
            <select name="easy_pick" class="lottery_sel_select event-easy-pick-select">
                <option></option>
                <option value="/en/play-lottery/eurojackpot/?from=play_table&amp;easy_pick=1&amp;extra_jackpot=" data-event-easy-pick="1">1 line for $ 5.76</option>
            ...
            <div class="lottery_sel_dropdown">
                <div class="offers">
                    <p><a href="/en/play-lottery/eurojackpot/?from=play_table&amp;easy_pick=1&amp;extra_jackpot=" class="event-easy-pick-offer">1 line for $ 5.76</a></p>
                    <p><a href="/en/play-lottery/eurojackpot/?from=play_table&amp;easy_pick=3&amp;extra_jackpot=" class="event-easy-pick-offer">3 lines for $ 16.76</a></p>
                </div>
                <div class="or">–––––&nbsp;or&nbsp;–––––</div>
...
<div class="lotteries_item_img">
    <a href="/en/play-lottery/euromillions/?from=play_table&amp;extra_jackpot=">
        <img src="https://static.cdnland.com/upload/images/logo/svg/euromillions.svg" alt="EuroMillions">
    </a>
</div>
<div class="lotteries_item_fl">
...
<div class="lotteries_item_bot">
    ...
    <div class="lottery_sel">
        ...
        <div class="event-easy-pick-cont">
            <select name="easy_pick" class="lottery_sel_select event-easy-pick-select">
                <option></option>
                <option value="/en/play-lottery/euromillions/?from=play_table&amp;easy_pick=1&amp;extra_jackpot=" data-event-easy-pick="1">1 line for $ 6.20</option>
            ...
            <div class="lottery_sel_dropdown">
                <div class="offers">
                    <p><a href="/en/play-lottery/euromillions/?from=play_table&amp;easy_pick=1&amp;extra_jackpot=" class="event-easy-pick-offer">1 line for $ 6.20</a></p>
                    <p><a href="/en/play-lottery/euromillions/?from=play_table&amp;easy_pick=3&amp;extra_jackpot=" class="event-easy-pick-offer">3 lines for $ 18.04</a></p>
                </div>
                <div class="or">–––––&nbsp;or&nbsp;–––––</div>
...
<div class="lotteries_item_img">
    <a href="/en/play-lottery/france-loto/?from=play_table&amp;extra_jackpot=">
        <img src="https://static.cdnland.com/upload/images/logo/svg/france-lotto.svg" alt="France Loto">
    </a>
</div>
<div class="lotteries_item_fl">
...
<div class="lotteries_item_bot">
    ...
    <div class="lottery_sel">
        ...
        <div class="event-easy-pick-cont">
            <select name="easy_pick" class="lottery_sel_select event-easy-pick-select">
                <option></option>
                <option value="/en/play-lottery/france-loto/?from=play_table&amp;easy_pick=1&amp;extra_jackpot=" data-event-easy-pick="1">1 line for $ 6.20</option>
            ...
            <div class="lottery_sel_dropdown">
                <div class="offers">
                    <p><a href="/en/play-lottery/france-loto/?from=play_table&amp;easy_pick=1&amp;extra_jackpot=" class="event-easy-pick-offer">1 line for $ 6.20</a></p>
                    <p><a href="/en/play-lottery/france-loto/?from=play_table&amp;easy_pick=3&amp;extra_jackpot=" class="event-easy-pick-offer">3 lines for $ 17.67</a></p>
                </div>
                <div class="or">–––––&nbsp;or&nbsp;–––––</div>
...
<div class="lotteries_item_img">
    <a href="/en/play-lottery/uk-lotto/?from=play_table&amp;extra_jackpot=">
        <img src="https://static.cdnland.com/upload/images/logo/svg/uk_lotto.svg" alt="UK Lotto">
    </a>
</div>
<div class="lotteries_item_fl">
...
<div class="lotteries_item_bot">
    ...
    <div class="lottery_sel">
        ...
        <div class="event-easy-pick-cont">
            <select name="easy_pick" class="lottery_sel_select event-easy-pick-select">
                <option></option>
                <option value="/en/play-lottery/uk-lotto/?from=play_table&amp;easy_pick=1&amp;extra_jackpot=" data-event-easy-pick="1">1 line for $ 7.41</option>
            ...
            <div class="lottery_sel_dropdown">
                <div class="offers">
                    <p><a href="/en/play-lottery/uk-lotto/?from=play_table&amp;easy_pick=1&amp;extra_jackpot=" class="event-easy-pick-offer">1 line for $ 7.41</a></p>
                    <p><a href="/en/play-lottery/uk-lotto/?from=play_table&amp;easy_pick=3&amp;extra_jackpot=" class="event-easy-pick-offer">3 lines for $ 21.12</a></p>
                </div>
                <div class="or">–––––&nbsp;or&nbsp;–––––</div>
...
<div class="lotteries_item_img">
    <a href="/en/play-lottery/thunderball-uk/?from=play_table&amp;extra_jackpot=">
        <img src="https://static.cdnland.com/upload/images/logo/svg/thunderball_lotto.svg" alt="Thunderball UK">
    </a>
</div>
<div class="lotteries_item_fl">
...
<div class="lotteries_item_bot">
    ...
    <div class="lottery_sel">
        ...
        <div class="event-easy-pick-cont">
            <select name="easy_pick" class="lottery_sel_select event-easy-pick-select">
                <option></option>
                <option value="/en/play-lottery/thunderball-uk/?from=play_table&amp;easy_pick=1&amp;extra_jackpot=" data-event-easy-pick="1">1 line for $ 3.09</option>
            ...
            <div class="lottery_sel_dropdown">
                <div class="offers">
                    <p><a href="/en/play-lottery/thunderball-uk/?from=play_table&amp;easy_pick=1&amp;extra_jackpot=" class="event-easy-pick-offer">1 line for $ 3.09</a></p>
                    <p><a href="/en/play-lottery/thunderball-uk/?from=play_table&amp;easy_pick=3&amp;extra_jackpot=" class="event-easy-pick-offer">3 lines for $ 8.99</a></p>
                </div>
                <div class="or">–––––&nbsp;or&nbsp;–––––</div>
...
<div class="lotteries_item_img">
    <a href="/en/play-lottery/lotto-ie/?from=play_table&amp;extra_jackpot=">
        <img src="https://static.cdnland.com/upload/images/logo/svg/lotto_ireland.svg" alt="Lotto Ireland">
    </a>
</div>
<div class="lotteries_item_fl">
...
<div class="lotteries_item_bot">
    ...
    <div class="lottery_sel">
        ...
        <div class="event-easy-pick-cont">
            <select name="easy_pick" class="lottery_sel_select event-easy-pick-select">
                <option></option>
                <option value="/en/play-lottery/lotto-ie/?from=play_table&amp;easy_pick=2&amp;extra_jackpot=" data-event-easy-pick="1">2 lines for $ 10.88</option>
            ...
            <div class="lottery_sel_dropdown">
                <div class="offers">
                    <p><a href="/en/play-lottery/lotto-ie/?from=play_table&amp;easy_pick=2&amp;extra_jackpot=" class="event-easy-pick-offer">2 lines for $ 10.88</a></p>
                    <p><a href="/en/play-lottery/lotto-ie/?from=play_table&amp;easy_pick=4&amp;extra_jackpot=" class="event-easy-pick-offer">4 lines for $ 21.11</a></p>
                </div>
                <div class="or">–––––&nbsp;or&nbsp;–––––</div>
...
<div class="lotteries_item_img">
    <a href="/en/play-lottery/ie-daily-million/?from=play_table&amp;extra_jackpot=">
        <img src="https://static.cdnland.com/upload/images/logo/svg/daily_million.svg" alt="Daily Million">
    </a>
</div>
<div class="lotteries_item_fl">
    <div class="lotteries_item_val text-nowrap d-none d-sm-block">€ 1+ <span class="mln_icon_extra text-nowrap">Million </span></div>
...
<div class="lotteries_item_bot">
    ...
    <div class="lottery_sel">
        ...
        <div class="event-easy-pick-cont">
            <select name="easy_pick" class="lottery_sel_select event-easy-pick-select">
                <option></option>
                <option value="/en/play-lottery/ie-daily-million/?from=play_table&amp;easy_pick=3&amp;extra_jackpot=" data-event-easy-pick="1">3 lines for $ 8.16</option>
            ...
            <div class="lottery_sel_dropdown">
                <div class="offers">
                    <p><a href="/en/play-lottery/ie-daily-million/?from=play_table&amp;easy_pick=3&amp;extra_jackpot=" class="event-easy-pick-offer">3 lines for $ 8.16</a></p>
                    <p><a href="/en/play-lottery/ie-daily-million/?from=play_table&amp;easy_pick=5&amp;extra_jackpot=" class="event-easy-pick-offer">5 lines for $ 12.92</a></p>
                </div>
                <div class="or">–––––&nbsp;or&nbsp;–––––</div>
...
<div class="lotteries_item_img">
    <a href="/en/play-lottery/superenalotto/?from=play_table&amp;extra_jackpot=">
        <img src="https://static.cdnland.com/upload/images/logo/svg/superenalotto.svg" alt="SuperEnalotto">
    </a>
</div>
<div class="lotteries_item_fl">
...
<div class="lotteries_item_bot">
    ...
    <div class="lottery_sel">
        ...
        <div class="event-easy-pick-cont">
            <select name="easy_pick" class="lottery_sel_select event-easy-pick-select">
                <option></option>
                <option value="/en/play-lottery/superenalotto/?from=play_table&amp;easy_pick=1&amp;extra_jackpot=" data-event-easy-pick="1">1 line for $ 3.04</option>
            ...
            <div class="lottery_sel_dropdown">
                <div class="offers">
                    <p><a href="/en/play-lottery/superenalotto/?from=play_table&amp;easy_pick=1&amp;extra_jackpot=" class="event-easy-pick-offer">1 line for $ 3.04</a></p>
                    <p><a href="/en/play-lottery/superenalotto/?from=play_table&amp;easy_pick=3&amp;extra_jackpot=" class="event-easy-pick-offer">3 lines for $ 8.85</a></p>
                </div>
                <div class="or">–––––&nbsp;or&nbsp;–––––</div>
...
<div class="lotteries_item_img">
    <a href="/en/play-lottery/mexico-melate/?from=play_table&amp;extra_jackpot=">
        <img src="https://static.cdnland.com/upload/images/logo/svg/melate_logo.svg" alt="Mexico Melate">
    </a>
</div>
<div class="lotteries_item_fl">
...
<div class="lotteries_item_bot">
    ...
    <div class="lottery_sel">
        ...
        <div class="event-easy-pick-cont">
            <select name="easy_pick" class="lottery_sel_select event-easy-pick-select">
                <option></option>
                <option value="/en/play-lottery/mexico-melate/?from=play_table&amp;easy_pick=5&amp;extra_jackpot=" data-event-easy-pick="1">5 lines for $ 10.40</option>
            ...
            <div class="lottery_sel_dropdown">
                <div class="offers">
                    <p><a href="/en/play-lottery/mexico-melate/?from=play_table&amp;easy_pick=5&amp;extra_jackpot=" class="event-easy-pick-offer">5 lines for $ 10.40</a></p>
                    <p><a href="/en/play-lottery/mexico-melate/?from=play_table&amp;easy_pick=10&amp;extra_jackpot=" class="event-easy-pick-offer">10 lines for $ 19.76</a></p>
                </div>
                <div class="or">–––––&nbsp;or&nbsp;–––––</div>
...
<div class="lotteries_item_img">
    <a href="/en/play-lottery/poland-lotto/?from=play_table&amp;extra_jackpot=">
        <img src="https://static.cdnland.com/upload/images/logo/svg/lotto_pl.svg" alt="Poland Lotto">
    </a>
</div>
<div class="lotteries_item_fl">
...
<div class="lotteries_item_bot">
    ...
    <div class="lottery_sel">
        ...
        <div class="event-easy-pick-cont">
            <select name="easy_pick" class="lottery_sel_select event-easy-pick-select">
                <option></option>
                <option value="/en/play-lottery/poland-lotto/?from=play_table&amp;easy_pick=3&amp;extra_jackpot=" data-event-easy-pick="1">3 lines for $ 5.22</option>
            ...
            <div class="lottery_sel_dropdown">
                <div class="offers">
                    <p><a href="/en/play-lottery/poland-lotto/?from=play_table&amp;easy_pick=3&amp;extra_jackpot=" class="event-easy-pick-offer">3 lines for $ 5.22</a></p>
                    <p><a href="/en/play-lottery/poland-lotto/?from=play_table&amp;easy_pick=5&amp;extra_jackpot=" class="event-easy-pick-offer">5 lines for $ 8.09</a></p>
                </div>
                <div class="or">–––––&nbsp;or&nbsp;–––––</div>
...
<div class="lotteries_item_img">
    <a href="/en/play-lottery/mega-millions/?from=play_table&amp;extra_jackpot=">
        <img src="https://static.cdnland.com/upload/images/logo/svg/megamillions.svg" alt="MEGA Millions">
    </a>
</div>
<div class="lotteries_item_fl">
...
<div class="lotteries_item_bot">
    ...
    <div class="lottery_sel">
        ...
        <div class="event-easy-pick-cont">
            <select name="easy_pick" class="lottery_sel_select event-easy-pick-select">
                <option></option>
                <option value="/en/play-lottery/mega-millions/?from=play_table&amp;easy_pick=1&amp;extra_jackpot=" data-event-easy-pick="1">1 line for $ 5.29</option>
            ...
            <div class="lottery_sel_dropdown">
                <div class="offers">
                    <p><a href="/en/play-lottery/mega-millions/?from=play_table&amp;easy_pick=1&amp;extra_jackpot=" class="event-easy-pick-offer">1 line for $ 5.29</a></p>
                    <p><a href="/en/play-lottery/mega-millions/?from=play_table&amp;easy_pick=3&amp;extra_jackpot=" class="event-easy-pick-offer">3 lines for $ 14.92</a></p>
                </div>
                <div class="or">–––––&nbsp;or&nbsp;–––––</div>
...
<div class="lotteries_item_img">
    <a href="/en/play-lottery/ca-fantasy-5/?from=play_table&amp;extra_jackpot=">
        <img src="https://static.cdnland.com/upload/images/logo/svg/fantasy5.svg" alt="California Fantasy 5">
    </a>
</div>
<div class="lotteries_item_fl">
...
<div class="lotteries_item_bot">
    ...
    <div class="lottery_sel">
        ...
        <div class="event-easy-pick-cont">
            <select name="easy_pick" class="lottery_sel_select event-easy-pick-select">
                <option></option>
                <option value="/en/play-lottery/ca-fantasy-5/?from=play_table&amp;easy_pick=3&amp;extra_jackpot=" data-event-easy-pick="1">3 lines for $ 7.50</option>
            ...
            <div class="lottery_sel_dropdown">
                <div class="offers">
                    <p><a href="/en/play-lottery/ca-fantasy-5/?from=play_table&amp;easy_pick=3&amp;extra_jackpot=" class="event-easy-pick-offer">3 lines for $ 7.50</a></p>
                    <p><a href="/en/play-lottery/ca-fantasy-5/?from=play_table&amp;easy_pick=5&amp;extra_jackpot=" class="event-easy-pick-offer">5 lines for $ 11.87</a></p>
                </div>
                <div class="or">–––––&nbsp;or&nbsp;–––––</div>
...
<div class="lotteries_item_img">
    <a href="/en/play-lottery/lotto-america/?from=play_table&amp;extra_jackpot=">
        <img src="https://static.cdnland.com/upload/images/logo/svg/lotto_america.svg" alt="Lotto America">
    </a>
</div>
<div class="lotteries_item_fl">
...
<div class="lotteries_item_bot">
    ...
    <div class="lottery_sel">
        ...
        <div class="event-easy-pick-cont">
            <select name="easy_pick" class="lottery_sel_select event-easy-pick-select">
                <option></option>
                <option value="/en/play-lottery/lotto-america/?from=play_table&amp;easy_pick=1&amp;extra_jackpot=" data-event-easy-pick="1">1 line for $ 3.29</option>
            ...
            <div class="lottery_sel_dropdown">
                <div class="offers">
                    <p><a href="/en/play-lottery/lotto-america/?from=play_table&amp;easy_pick=1&amp;extra_jackpot=" class="event-easy-pick-offer">1 line for $ 3.29</a></p>
                    <p><a href="/en/play-lottery/lotto-america/?from=play_table&amp;easy_pick=3&amp;extra_jackpot=" class="event-easy-pick-offer">3 lines for $ 9.57</a></p>
                </div>
                <div class="or">–––––&nbsp;or&nbsp;–––––</div>
...
<div class="lotteries_item_img">
    <a href="/en/play-lottery/megabucks/?from=play_table&amp;extra_jackpot=">
        <img src="https://static.cdnland.com/upload/images/logo/svg/megabucks.svg" alt="Wisconsin Megabucks">
    </a>
</div>
<div class="lotteries_item_fl">
    <div class="lotteries_item_val text-nowrap d-none d-sm-block">$ 1 <span class="mln_icon_extra text-nowrap">Million </span></div>
...
<div class="lotteries_item_bot">
    ...
    <div class="lottery_sel">
        ...
        <div class="event-easy-pick-cont">
            <select name="easy_pick" class="lottery_sel_select event-easy-pick-select">
                <option></option>
                <option value="/en/play-lottery/megabucks/?from=play_table&amp;easy_pick=2&amp;extra_jackpot=" data-event-easy-pick="1">2 lines for $ 3.30</option>
            ...
            <div class="lottery_sel_dropdown">
                <div class="offers">
                    <p><a href="/en/play-lottery/megabucks/?from=play_table&amp;easy_pick=2&amp;extra_jackpot=" class="event-easy-pick-offer">2 lines for $ 3.30</a></p>
                    <p><a href="/en/play-lottery/megabucks/?from=play_table&amp;easy_pick=5&amp;extra_jackpot=" class="event-easy-pick-offer">5 lines for $ 7.67</a></p>
                </div>
                <div class="or">–––––&nbsp;or&nbsp;–––––</div>
...
<div class="lotteries_item_img">
    <a href="/en/play-lottery/cash-for-life/?from=play_table&amp;extra_jackpot=">
        <img src="https://static.cdnland.com/upload/images/logo/svg/cash4life.svg" alt="Cash4Life">
    </a>
</div>
<div class="lotteries_item_fl">
...
<div class="lotteries_item_bot">
    ...
    <div class="lottery_sel">
        ...
        <div class="event-easy-pick-cont">
            <select name="easy_pick" class="lottery_sel_select event-easy-pick-select">
                <option></option>
                <option value="/en/play-lottery/cash-for-life/?from=play_table&amp;easy_pick=1&amp;extra_jackpot=" data-event-easy-pick="1">1 line for $ 5.00</option>
            ...
            <div class="lottery_sel_dropdown">
                <div class="offers">
                    <p><a href="/en/play-lottery/cash-for-life/?from=play_table&amp;easy_pick=1&amp;extra_jackpot=" class="event-easy-pick-offer">1 line for $ 5.00</a></p>
                    <p><a href="/en/play-lottery/cash-for-life/?from=play_table&amp;easy_pick=3&amp;extra_jackpot=" class="event-easy-pick-offer">3 lines for $ 14.25</a></p>
                </div>
                <div class="or">–––––&nbsp;or&nbsp;–––––</div>
...
<div class="lotteries_item_img">
    <a href="/en/play-lottery/powerball/?from=play_table&amp;extra_jackpot=">
        <img src="https://static.cdnland.com/upload/images/logo/svg/powerball.svg" alt="Powerball">
    </a>
</div>
<div class="lotteries_item_fl">
...
<div class="lotteries_item_bot">
    ...
    <div class="lottery_sel">
        ...
        <div class="event-easy-pick-cont">
            <select name="easy_pick" class="lottery_sel_select event-easy-pick-select">
                <option></option>
                <option value="/en/play-lottery/powerball/?from=play_table&amp;easy_pick=1&amp;extra_jackpot=" data-event-easy-pick="1">1 line for $ 5.29</option>
            ...
            <div class="lottery_sel_dropdown">
                <div class="offers">
                    <p><a href="/en/play-lottery/powerball/?from=play_table&amp;easy_pick=1&amp;extra_jackpot=" class="event-easy-pick-offer">1 line for $ 5.29</a></p>
                    <p><a href="/en/play-lottery/powerball/?from=play_table&amp;easy_pick=3&amp;extra_jackpot=" class="event-easy-pick-offer">3 lines for $ 14.92</a></p>
                </div>
                <div class="or">–––––&nbsp;or&nbsp;–––––</div>
...
<div class="lotteries_item_img">
    <a href="/en/play-lottery/superlotto-plus/?from=play_table&amp;extra_jackpot=">
        <img src="https://static.cdnland.com/upload/images/logo/svg/superlotto-plus.svg" alt="SuperLotto Plus">
    </a>
</div>
<div class="lotteries_item_fl">
...
<div class="lotteries_item_bot">
    ...
    <div class="lottery_sel">
        ...
        <div class="event-easy-pick-cont">
            <select name="easy_pick" class="lottery_sel_select event-easy-pick-select">
                <option></option>
                <option value="/en/play-lottery/superlotto-plus/?from=play_table&amp;easy_pick=2&amp;extra_jackpot=" data-event-easy-pick="1">2 lines for $ 5.98</option>
            ...
            <div class="lottery_sel_dropdown">
                <div class="offers">
                    <p><a href="/en/play-lottery/superlotto-plus/?from=play_table&amp;easy_pick=2&amp;extra_jackpot=" class="event-easy-pick-offer">2 lines for $ 5.98</a></p>
                    <p><a href="/en/play-lottery/superlotto-plus/?from=play_table&amp;easy_pick=3&amp;extra_jackpot=" class="event-easy-pick-offer">3 lines for $ 8.52</a></p>
                </div>
                <div class="or">–––––&nbsp;or&nbsp;–––––</div>
...
<div class="lotteries_item_img">
    <a href="/en/play-lottery/new-york-lotto/?from=play_table&amp;extra_jackpot=">
        <img src="https://static.cdnland.com/upload/images/logo/svg/new-york.svg" alt="New York Lotto">
    </a>
</div>
<div class="lotteries_item_fl">
...
<div class="lotteries_item_bot">
    ...
    <div class="lottery_sel">
        ...
        <div class="event-easy-pick-cont">
            <select name="easy_pick" class="lottery_sel_select event-easy-pick-select">
                <option></option>
                <option value="/en/play-lottery/new-york-lotto/?from=play_table&amp;easy_pick=2&amp;extra_jackpot=" data-event-easy-pick="1">2 lines for $ 3.00</option>
            ...
            <div class="lottery_sel_dropdown">
                <div class="offers">
                    <p><a href="/en/play-lottery/new-york-lotto/?from=play_table&amp;easy_pick=2&amp;extra_jackpot=" class="event-easy-pick-offer">2 lines for $ 3.00</a></p>
                    <p><a href="/en/play-lottery/new-york-lotto/?from=play_table&amp;easy_pick=4&amp;extra_jackpot=" class="event-easy-pick-offer">4 lines for $ 5.82</a></p>
                </div>
                <div class="or">–––––&nbsp;or&nbsp;–––––</div>
...
<div class="lotteries_item_img">
    <a href="/en/play-lottery/lotto-texas/?from=play_table&amp;extra_jackpot=">
        <img src="https://static.cdnland.com/upload/images/logo/svg/texas-lotto.svg" alt="Lotto Texas">
    </a>
</div>
<div class="lotteries_item_fl">
    <div class="lotteries_item_val text-nowrap d-none d-sm-block">$ 5+ <span class="mln_icon_extra text-nowrap">Million </span></div>
...
<div class="lotteries_item_bot">
    ...
    <div class="lottery_sel">
        ...
        <div class="event-easy-pick-cont">
            <select name="easy_pick" class="lottery_sel_select event-easy-pick-select">
                <option></option>
                <option value="/en/play-lottery/lotto-texas/?from=play_table&amp;easy_pick=1&amp;extra_jackpot=" data-event-easy-pick="1">1 line for $ 3.79</option>
            ...
            <div class="lottery_sel_dropdown">
                <div class="offers">
                    <p><a href="/en/play-lottery/lotto-texas/?from=play_table&amp;easy_pick=1&amp;extra_jackpot=" class="event-easy-pick-offer">1 line for $ 3.79</a></p>
                    <p><a href="/en/play-lottery/lotto-texas/?from=play_table&amp;easy_pick=3&amp;extra_jackpot=" class="event-easy-pick-offer">3 lines for $ 10.80</a></p>
                </div>
                <div class="or">–––––&nbsp;or&nbsp;–––––</div>
...
<div class="lotteries_item_img">
    <a href="/en/play-lottery/za-powerball/?from=play_table&amp;extra_jackpot=">
        <img src="https://static.cdnland.com/upload/images/logo/svg/powerball_za.svg" alt="South Africa Powerball">
    </a>
</div>
<div class="lotteries_item_fl">
...
<div class="lotteries_item_bot">
    ...
    <div class="lottery_sel">
        ...
        <div class="event-easy-pick-cont">
            <select name="easy_pick" class="lottery_sel_select event-easy-pick-select">
                <option></option>
                <option value="/en/play-lottery/za-powerball/?from=play_table&amp;easy_pick=5&amp;extra_jackpot=" data-event-easy-pick="1">5 lines for $ 4.20</option>
            ...
            <div class="lottery_sel_dropdown">
                <div class="offers">
                    <p><a href="/en/play-lottery/za-powerball/?from=play_table&amp;easy_pick=5&amp;extra_jackpot=" class="event-easy-pick-offer">5 lines for $ 4.20</a></p>
                    <p><a href="/en/play-lottery/za-powerball/?from=play_table&amp;easy_pick=10&amp;extra_jackpot=" class="event-easy-pick-offer">10 lines for $ 7.90</a></p>
                </div>
                <div class="or">–––––&nbsp;or&nbsp;–––––</div>
...
<div class="lotteries_item_img">
    <a href="/en/play-lottery/za-daily-lotto/?from=play_table&amp;extra_jackpot=">
        <img src="https://static.cdnland.com/upload/images/logo/svg/daily_lotto.svg" alt="South Africa Daily Lotto">
    </a>
</div>
<div class="lotteries_item_fl">
...
<div class="lotteries_item_bot">
    ...
    <div class="lottery_sel">
        ...
        <div class="event-easy-pick-cont">
            <select name="easy_pick" class="lottery_sel_select event-easy-pick-select">
                <option></option>
                <option value="/en/play-lottery/za-daily-lotto/?from=play_table&amp;easy_pick=10&amp;extra_jackpot=" data-event-easy-pick="1">10 lines for $ 4.27</option>
            ...
            <div class="lottery_sel_dropdown">
                <div class="offers">
                    <p><a href="/en/play-lottery/za-daily-lotto/?from=play_table&amp;easy_pick=10&amp;extra_jackpot=" class="event-easy-pick-offer">10 lines for $ 4.27</a></p>
                    <p><a href="/en/play-lottery/za-daily-lotto/?from=play_table&amp;easy_pick=15&amp;extra_jackpot=" class="event-easy-pick-offer">15 lines for $ 6.34</a></p>
                </div>
                <div class="or">–––––&nbsp;or&nbsp;–––––</div>
...
<div class="lotteries_item_img">
    <a href="/en/play-lottery/za-lotto-652/?from=play_table&amp;extra_jackpot=">
        <img src="https://static.cdnland.com/upload/images/logo/svg/lotto_za.svg" alt="South Africa Lotto 6/52">
    </a>
</div>
<div class="lotteries_item_fl">
...
<div class="lotteries_item_bot">
    ...
    <div class="lottery_sel">
        ...
        <div class="event-easy-pick-cont">
            <select name="easy_pick" class="lottery_sel_select event-easy-pick-select">
                <option></option>
                <option value="/en/play-lottery/za-lotto-652/?from=play_table&amp;easy_pick=5&amp;extra_jackpot=" data-event-easy-pick="1">5 lines for $ 4.20</option>
            ...
            <div class="lottery_sel_dropdown">
                <div class="offers">
                    <p><a href="/en/play-lottery/za-lotto-652/?from=play_table&amp;easy_pick=5&amp;extra_jackpot=" class="event-easy-pick-offer">5 lines for $ 4.20</a></p>
                    <p><a href="/en/play-lottery/za-lotto-652/?from=play_table&amp;easy_pick=10&amp;extra_jackpot=" class="event-easy-pick-offer">10 lines for $ 7.90</a></p>
                </div>
                <div class="or">–––––&nbsp;or&nbsp;–––––</div>
...
<div class="row">
    <div class="col-lg-12">
        <div class="text-muted page_txt"></div>
    </div>
</div>
</div>
</section>
...
<script>
function lotteries_view(inx) {
inx = inx || 0;
let $items = $('#lotteries-views .lotteries-view');
$items.removeClass('active');
$($items.get(inx)).addClass('active');
if (inx == 1) {
    $('.lotteries').addClass('lotteries-mod');
    $('.lotteries .lotteries_item_cont').removeClass('col-lg-4').removeClass('col-md-6').addClass('col-12');
} else {
    $('.lotteries').removeClass('lotteries-mod');
    $('.lotteries .lotteries_item_cont').removeClass('col-12').addClass('col-lg-4').addClass('col-md-6');
}
setCookie('lotteries_view', inx);
}
...
if (word) {
    ...
    $('.ad-block').removeClass('d-none');
    $('.lotteries_item_cont').removeClass('d-none');
}
}

function lotteries_sorting_callback() {
let lotteries_view_inx = 0;
$('#lotteries-views .lotteries-view').each(function(inx){
    if ($(this).hasClass('active')) {
        lotteries_view_inx = inx;
        return;
    }
});
lotteries_view(lotteries_view_inx);

search_lotto_by_name();
...
lotteries_view(getCookie('lotteries_view'));
});
</script>
